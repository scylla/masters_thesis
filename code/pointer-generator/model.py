...
from util import task_specific_attention
...
class SummarizationModel(object):
  ...
  def _add_placeholders(self):
    ...
    # for amrs hierarchial model is used
    self.amr_inputs = tf.placeholder(
          shape=(None, None, None), dtype=tf.int32, name='amr_inputs')

    # [document x sentence] number of words per sentence
    self.amr_word_lengths = tf.placeholder(
        shape=(None, None), dtype=tf.int32, name='amr_word_lengths')

      # [document] number of sentences per document
    self.amr_sentence_lengths = tf.placeholder(
        shape=(None,), dtype=tf.int32, name='amr_sentence_lengths')
